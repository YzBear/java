...
public class GenerateCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/spring_boot_mybatisplus/src/main/java");
        gc.setAuthor("yzx");//作者名称
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/orcl? useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.example.spring_boot_mybatisplus"); //包名
