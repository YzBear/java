...
public class EmailController {
	...
	public String sendSimpleEmail() {
		try {
			...
			message.setTo("iyanzixiong@gmail.com"); // 接收地址
	...
	public String sendHtmlEmail() {
		...
		try {
			...
			helper.setFrom(from); 
			helper.setTo("iyanzixiong@gmail.com"); // 接收地址
	...
	public String sendAttachmentsMail() {
		...
		try {
			...
			// 传入附件
			/*Class<? extends EmailController> aClass = this.getClass();
			URL resource = aClass.getResource("src/main/resources/static/file/项目文档.docx");
			String path = resource.getPath();


			File file1 = new File(path);*/
			FileSystemResource file = new FileSystemResource(new File("static//file//项目文档.docx"));
	...
	public String sendInlineMail() {
		...
		try {
			...
			// 传入附件
			FileSystemResource file = new FileSystemResource(new File(this.getClass().getResource("static/img/sunshine.png").getPath()));
